...
(function() {
  ...
  function injectHeaderStyles() {
    ...
    style.textContent = `
      ...
      /* В мобильной версии убираем все трансформации для кнопки */
      ...
      .sidebar-menu {
        ...
        height: 100vh;
        width: 320px;
        background: linear-gradient(135deg, #c2d2d6, #9ba8ab);
        ...
        border-right: 1px solid #ff110020;
      }
      ...
      /* В мобильной версии кнопка меню не должна подниматься при открытии */
      @media (max-width: 768px) {
        .site-header.sidebar-active .sidebar-toggle {
          transform: none;
        }
      }
      ...
      .sidebar-menu::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(45deg, transparent 0%, #ff110005 50%, transparent 100%);
        opacity: 0;
      ...
      .sidebar-header {
        ...
        margin-top: 2rem;
        padding-bottom: 1rem;
        border-bottom: 2px solid #ff110040;
      }
    ...
    return `<header class="site-header">
      <div class="header-content">
        ...
        <div class="site-branding">
          <h1 class="site-title">
            <a href="index.html">ЗевсПротивАида</a>
          </h1>
        ...
        <nav class="nav-menu">
          <a href="olympus.html" class="nav-link">олимп</a><a href="powerofgods.html" class="nav-link">сила богов</a><a href="earlyaccess.html" class="nav-link">доступ</a><a href="contact.html" class="nav-link">Контакты</a>
        </nav>
      ...
      <div class="sidebar-menu">
        <div class="sidebar-header">
          <h3 class="sidebar-title">ЗевсПротивАида</h3>
          <button class="sidebar-close" aria-label="Закрыть меню">×</button>
        </div>
        <div class="sidebar-links">
          <a href="olympus.html" class="sidebar-link">олимп</a><a href="powerofgods.html" class="sidebar-link">сила богов</a><a href="earlyaccess.html" class="sidebar-link">доступ</a><a href="chronicles.html" class="sidebar-link">хроники</a><a href="oracle.html" class="sidebar-link">оракул</a><a href="voices.html" class="sidebar-link">голоса</a><a href="myths.html" class="sidebar-link">мифы</a><a href="contact.html" class="sidebar-link">Контакты</a>
        </div>
      </div>
